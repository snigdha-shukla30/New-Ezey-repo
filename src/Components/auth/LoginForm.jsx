...
//         {/* ✅ Bar icon ( | ) added before show/hide icon */}
//         <span
//           className="
//             absolute
//             right-[40px]
...
//       {/* ✅ 4) SignIn button ke upar right side New User Signup */}
//       <div className="flex justify-end mb-2 mr-10">
//         <p className="text-xs text-[#7A8C94]">
//           New user ?{" "}
//           <span
...
//       {/* <div className="flex justify-center mb-6 mt-2 hover:drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]
//   hover:shadow-inner">
//         <Button
//           variant="primary"
//           onClick={handleSubmit}
