...
//                 </svg>
//                 {/* Foreground blue semi-circle */}
//                 <svg className="absolute inset-0 w-full h-full transition-all duration-300 group-hover:opacity-80" viewBox="0 0 100 50" preserveAspectRatio="xMidYMid meet">
//                   <path
//                     d="M 10 45 A 40 40 0 0 1 90 45"
//                     fill="none"
//                     stroke="#4BACCE"
...
//                 {/* Percentage text */}
//                 <div className="absolute inset-0 flex items-end justify-center pb-1">
//                   <span className="text-[12px] font-semibold text-[#265768]" style={{ fontFamily: 'Mulish, sans-serif', lineHeight: '150%' }}>
//                     {item.value}
//                   </span>
//                 </div>
//               </div>
