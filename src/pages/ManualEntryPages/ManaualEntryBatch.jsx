...
//   // ✅ Form now based on backend payload
//   const [form, setForm] = useState({
//     course: "", // degree
//     department: "",
//     name: "", // section
...
//   const resolveSubjectName = (id) => {
//     const found = subjectsList.find((s) => s?._id === id);
//     if (found) return `${found.name}${found.code ? ` (${found.code})` : ""}`;
//     return id || "Subject";
//   };

//   const resolveFacultyName = (id) => {
...
//       const code = `${form.department}_${form.semester}_${form.name}_2025`;

//       const payload = {
//         name: form.name, // section name
//         course: form.course,
//         code: code,
//         semester: Number(form.semester),
//         department: form.department,
...
//       department: batch.department || "",
//       name: batch.name || batch.section || "",
//       strength: batch.strength?.toString() || batch.capacity?.toString() || "",
//       semester: batch.semester?.toString() || "",
//       subject: firstPair?.subject || "",
//       faculty: firstPair?.faculty || "",
//     });
...
//                           <div
//                             onClick={() =>
//                               openListPopup("Assigned Subjects", item.subjects || [])
//                             }
//                             className="flex-1 text-[13px] text-[#4BACCE] cursor-pointer hover:underline text-center"
//                           >
//                             {Array.isArray(item.subjects)
...
//                           <div
//                             onClick={() =>
//                               openListPopup("Assigned Faculty", item.subjects || [])
//                             }
//                             className="flex-1 text-[13px] text-[#4BACCE] cursor-pointer hover:underline text-center"
//                           >
//                             {Array.isArray(item.subjects)
...
//                         >
//                           {popupTitle === "Assigned Subjects"
//                             ? resolveSubjectName(pair?.subject)
//                             : resolveFacultyName(pair?.faculty)}
//                         </li>
//                       ))}
//                     </ul>
//                   )}
